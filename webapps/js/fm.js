...
function startSimulator() {
    ...
    console.log($("#fmMin").val(),$("#fmMax").val());
    var data ={
        fmMin: $("#fmMin").val(),
        fmMax: $("#fmMax").val(),
        devId : $("#dev-id").val() == "" ? "DEV003": $("#dev-id").val(),
        devModel : $("#dev-model").val() == "" ? "BSKP_FM": $("#dev-model").val(),
        simid :SIM_ID,
        tl : $('#sim').val(),
        mid:MESSAGE_ID,
